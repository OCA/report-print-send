...
class ReportController(ReportController):
    ...
    def report_download(self, data, context=None, token=None):
        ...
        The cors header has to be set to * as there has to be a call
        to the actual printer, which is probably in the local network of
        the using client.
        ...
        try:
            ...
            label_format = (
                requestcontent[3] if len(requestcontent) == 4 else DEFAULT_FORMAT
            )
            ...
            if docids:
                ...
                response = self.report_routes(
                    ...
                    docids=docids,
                    context=json.dumps(
                        {"resolution": resolution, "format": label_format}
                    ),
                    converter="text",
                )
            else:
