...
It allows managing multiple printers and choose on the client which printer to use.
This module is not about changing the layout of labels, but about communication with the printers.
